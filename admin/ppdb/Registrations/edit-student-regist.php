                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" name="tahunajaran_id" id="tahunajaran_idedit" data-placeholder="Pilih Tahun Ajaran">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <select class="form-control select2" name="ppdbjurusan_id" id="ppdbjurusan_idedit" data-placeholder="Pilih Tahun Ajaran">
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1 row">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" id="ppdbregist_nik" name="ppdbregist_nik" class="form-control" placeholder="NO NIK" value="<?= $t_ppdbregist['ppdbregist_nik']; ?>" readonly />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-12">
                                <div class="mb-1 row">
                                    <div class="col-sm-3">
                                        <label class="col-form-label text-uppercase" for="password">Password</label>
                                    </div>
                                    <div class="col-sm-9">
                                        <input type="password" id="password" class="form-control" name="password" value="<?= $t_ppdbregist['password']; ?>" placeholder="Password" />
                                    </div>
                                </div>
                            </div>
