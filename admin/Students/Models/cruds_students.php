            ...
            foreach ($sheetNames as $sheetIndex => $sheetName) {
                if ($sheetName == 'upload_siswa') {
                    ...
                    for ($i = 1; $i < count($sheetData); $i++) {
                        ...
                        $cek_id_siswa = rowcount($koneksi, 'f_siswa', ['siswa_id_kota' => $siswa_act_uuid]);
                        if (
                            $siswa_act_nama     == "" &&
                            $siswa_act_gender   == "" &&
                            $siswa_act_nis      == "" &&
                        ...
                        if ($cek_id_siswa <> 0) {
                            ...
                            $exec .= update($koneksi, 'f_riwayatsiswa', $f_riwayatsiswa, ['siswa_id_kota' => $siswa_act_uuid]);
                            ...
                            $exec .= insert($koneksi, 'f_riwayatsiswa', $f_riwayatsiswa);
