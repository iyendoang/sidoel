<div class="row">
    <div class="col-12">
        <ul class="nav nav-pills nav-fill mb-2 studentRegist-nav-form">
            <!-- edit-student-regist -->
            <li class="nav-item">
                <a class="nav-link active" href="?pg=edit-student-regist">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="?pg=edit-student-address">
            ...
            <!-- edit-student-parent -->
            <li class="nav-item">
                <a class="nav-link active" href="?pg=edit-student-parent">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="?pg=edit-student-previous-level">
            ...
            <li class="nav-item">
                <a class="nav-link active" href="?pg=edit-student-upload-file">
