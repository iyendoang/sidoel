...
if ($pg == 'updateRegistrations') {
    ...
    if ($cek_nisn == true) {
        ...
        $execute = update($koneksi, 't_ppdbregist', $t_ppdbregist, ['ppdbregist_id' => $id]);
        if ($execute) {
            $response = [
                ...
                'icon'          => "success",
                'message'       => "Update data diri berhasil",
            ];
...
if ($pg == 'updateParentRegist') {
    ...
    if ($update_exec != "NO") {
        $response = [
            ...
            'title_message' => "Sukses",
            'icon' => "success",
            'message' => "Update data wali/orangtua data berhasil",
        ];
        echo json_encode($response);
    } else {
        $response = [
...
if ($pg == 'updatePreviousRegist') {
    ...
    if ($update_exec != "NO") {
        $response = [
            ...
            'title_message' => "Sukses",
            'icon' => "success",
            'message' => "Update Asal Sekolah data berhasil",
        ];
        echo json_encode($response);
    } else {
        $response = [
